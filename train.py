...
class DataTrainingArguments:
    ...
    dataset_name: Optional[str] = field(default= "xbgoose/ravdess", metadata={"help": "Name of a dataset from the datasets package"})
    ...
    label_column_name: str = field(
        default="emotion", metadata={"help": "The name of the dataset column containing the labels. Defaults to 'label'"}
    )
...
class ModelArguments:
    ...
    model_name_or_path: str = field(
        default="Rajaram1996/Hubert_emotion",
